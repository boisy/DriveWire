...
///
/// DriveWire defines [a protocol](https://sourceforge.net/p/drivewireserver/wiki/DriveWire_Specification/) for guest computers to access input/output resources on a host computer. DriveWire provides a number of advantages to smaller computers with limited storage and networking capabilities:
